<nav class="bg-white border-b border-gray-200 fixed w-full z-20 top-0 start-0">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="/img/pokedex.png" class="h-8" alt="pokeapp logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap">PokeApp</span>
        </a>
        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <button type="button"
                ...
                <img class="w-8 h-8 rounded-full" src="/img/th-1789345218.png" alt="user photo">
            </button>
            <!-- Dropdown menu -->
